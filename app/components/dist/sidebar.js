    ...
    return (React.createElement("div", { className: home_module_scss_1["default"].sidebar + " " + props.className + " " + (shouldNarrow && home_module_scss_1["default"]["narrow-sidebar"]) },
        React.createElement("div", { className: home_module_scss_1["default"]["sidebar-header"], "data-tauri-drag-region": true },
            ...
            React.createElement("div", { className: home_module_scss_1["default"]["sidebar-sub-title"], style: { border: '3px solid green', margin: '2px 2px', textAlign: 'center' } },
                ...
                React.createElement("a", { href: "https://www.doubao.com/", target: "_blank", rel: "noopener noreferrer", style: { backgroundColor: 'rgba(128, 128, 128, 0.25)', display: 'block', margin: 'auto', fontSize: '1.5em' } }, "\u8C46\u5305"),
                React.createElement("a", { href: "https://chat.deepseek.com/", target: "_blank", rel: "noopener noreferrer", style: { backgroundColor: 'rgba(128, 128, 128, 0.2)', display: 'block', margin: 'auto', fontSize: '1.5em' } }, "\u6DF1\u5EA6\u6C42\u7D22"),
                ...
                React.createElement("a", { href: "https://chatglm.cn/main/alltoolsdetail", target: "_blank", rel: "noopener noreferrer", style: { backgroundColor: 'rgba(128, 128, 128, 0.1)', display: 'block', margin: 'auto', fontSize: '1.5em' } }, "\u667A\u8C31\u6E05\u8A00"))),
